...
typedef struct EpochAppBridgeSnapshot {
    ...
    const char *revised_anchor_method;
    const char *revised_anchor_source;
    const char *revised_year_opening_policy;
    const char *revised_leap_day_policy;
    const char *revised_intercalary_policy;
    const char *revised_conversion_gate_reason;
    ...
    int revised_common_intercalary_days;
    int revised_leap_intercalary_days;
    int revised_constraints_customer_safe;
