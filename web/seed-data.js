window.EPOCH_SEED_DATA = {
  ...
  "monitorHealthChecks": [
    ...
    {
      "id": "monitor-check-seed-auth-prototype",
      "actionId": "seed-auth-provider-prototype",
      "receiptId": "receipt-auth-provider-prototype-seed",
      "title": "Sandbox auth provider prototype",
      "summary": "EPOCH has a local auth/session payload preview for public intake, customer status, raw admin denial, and raw monitor denial without production login, OAuth, secrets, credentials, tokens, webhooks, provider writes, external sessions, or customer-visible auth behavior.",
      "status": "complete",
      "priority": "high",
    ...
    {
      "id": "monitor-check-seed-marketing-analytics-prototype",
      "actionId": "seed-marketing-analytics-prototype",
      "receiptId": "receipt-marketing-analytics-prototype-seed",
      "title": "Sandbox marketing analytics adapter prototype",
      "summary": "EPOCH has a local conversion payload preview for provider-neutral analytics/ad readiness without live pixels, ad API writes, analytics credentials, webhooks, provider writes, invasive tracking, personal-data storage, cross-site identifiers, or customer-visible analytics.",
      "status": "complete",
      "priority": "high",
  ...
  "receipts": [
    ...
    {
      "id": "receipt-auth-provider-prototype-seed",
      "customerId": null,
      "kind": "auth-provider-prototype",
      "status": "complete",
      "createdAt": "2026-06-02T08:00:00+09:00",
      "note": "Sandbox auth provider prototype baseline: local access payload preview is ready; production login, OAuth, secrets, credentials, token storage, refresh-token storage, webhooks, provider writes, external sessions, and customer-visible auth behavior remain disabled."
    },
    {
      "id": "receipt-marketing-analytics-prototype-seed",
      "customerId": null,
      "kind": "marketing-analytics-adapter-prototype",
      "status": "complete",
      "createdAt": "2026-06-02T08:00:00+09:00",
      "note": "Sandbox marketing analytics adapter prototype baseline: local conversion payload preview is ready; live pixels, ad API writes, analytics credentials, webhooks, provider writes, invasive tracking, personal-data storage, cross-site identifiers, third-party cookies, fingerprinting, cross-device identity, customer-visible analytics, and under-19 paid action before consent remain disabled."
    },
    {
