...
for (const phrase of [
  ...
  "Native Scheduler Relationship Map",
  ...
  "NativeSchedulerRelationshipSummary",
  "NativeSchedulerRequestRelationship",
  "NativeSchedulerAvailabilityRelationship",
  "NativeSchedulerRecurrenceRelationship",
  "NativeSchedulerPortalRelationship",
